...
spit_start "Can we ping r01red"
ping -c 1 r01red
spit_end

spit_start "Can we ping r01blue"
ping -c 1 r01blue
spit_end
...
spit_start "Can we ping yoda"
ping -c 1 yoda
spit_end
spit_start "Can we access our Kickstart file from yoda"
curl http://yoda/Kickstart/default.ks | wc -l
spit_end
